...
// License: Apache-2.0
// Lato changes: nest under script; drop libc O_NOFOLLOW and tracing; use super::MAX_HOST_CALLS.
...
pub const MAX_JOURNAL_ENTRIES: usize = super::MAX_HOST_CALLS as usize;
