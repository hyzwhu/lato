// Derived from: Grok Build@bb7f39d5858cbf5e00de639367f59debbdcb0138:crates/codegen/xai-workflow/src/meta.rs
// License: Apache-2.0
// Lato changes: nest under script; use script meta limits + with_rhai_hint; reuse crate MAX_WORKFLOW_NAME_LEN.

use serde::{Deserialize, Serialize};

use super::{
    MAX_PHASE_DETAIL_LEN, MAX_PHASE_TITLE_LEN, MAX_WORKFLOW_DESCRIPTION_LEN, MAX_WORKFLOW_PHASES,
    MAX_WORKFLOW_WHEN_TO_USE_LEN, with_rhai_hint,
};
use crate::MAX_WORKFLOW_NAME_LEN;
...
pub fn extract_meta(script: &str) -> Result<WorkflowMeta, MetaError> {
    ...
    engine
        .compile(script)
        .map_err(|e| MetaError::Parse(with_rhai_hint(e.to_string())))?;
