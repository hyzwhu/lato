// Derived from: Grok Build@bb7f39d5858cbf5e00de639367f59debbdcb0138:crates/codegen/xai-grok-shell/src/session/workflow/schema_contract.rs
// License: Apache-2.0
// Lato changes: nested under lato-agent workflow host; no semantic edits.
